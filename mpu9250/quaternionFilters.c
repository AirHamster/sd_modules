...
extern volatile float q3;					// quaternion of sensor frame relative to auxiliary frame
extern volatile float integralFBx;
extern volatile float integralFBy;
extern volatile float integralFBz;	// integral error terms scaled by Ki

static float GyroMeasError = CONST_GME;
// gyroscope measurement drift in rad/s/s (start at 0.0 deg/s/s)
static float GyroMeasDrift = CONST_GMD;
