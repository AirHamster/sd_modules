\hypertarget{group___a_d_c}{}\doxysection{A\+DC Driver}
\label{group___a_d_c}\index{ADC Driver@{ADC Driver}}
...
\end{DoxyPrecond}
\hypertarget{group___a_d_c_adc_1}{}\doxysubsection{Driver State Machine}\label{group___a_d_c_adc_1}
...
\hypertarget{group___a_d_c_adc_2}{}\doxysubsection{A\+D\+C Operations}\label{group___a_d_c_adc_2}
The A\+DC driver is quite complex, an explanation of the terminology and of the operational details follows.\hypertarget{group___a_d_c_adc_2_1}{}\doxysubsubsection{A\+D\+C Conversion Groups}\label{group___a_d_c_adc_2_1}
The {\ttfamily A\+D\+C\+Conversion\+Group} is the objects that specifies a physical conversion operation. This structure contains some standard fields and several implementation-\/dependent fields.~\newline
 ...
 The implementation-\/dependent fields specify the physical A\+DC operation mode, the analog channels belonging to the group and any other implementation-\/specific setting. Usually the extra fields just mirror the physical A\+DC registers, please refer to the vendor\textquotesingle{}s M\+CU Reference Manual for details about the available settings. Details are also available into the documentation of the A\+DC low level drivers and in the various sample applications.\hypertarget{group___a_d_c_adc_2_2}{}\doxysubsubsection{A\+D\+C Conversion Modes}\label{group___a_d_c_adc_2_2}
...
\end{DoxyItemize}\hypertarget{group___a_d_c_adc_2_3}{}\doxysubsubsection{A\+D\+C Callbacks}\label{group___a_d_c_adc_2_3}
