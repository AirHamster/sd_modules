\href{https://travis-ci.org/ThrowTheSwitch/Unity}{\texttt{ }} {\bfseries{Copyright (c) 2007 -\/ 2017 Unity Project by Mike Karlesky, Mark Vander\+Voord, and Greg Williams}}\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md451}{}\doxysection{Running Tests}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md451}
\begin{DoxyVerb}RUN_TEST(func, linenum)
\end{DoxyVerb}


Each Test is run within the macro {\ttfamily R\+U\+N\+\_\+\+T\+E\+ST}. This macro performs necessary setup before the test is called and handles cleanup and result tabulation afterwards.\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md452}{}\doxysection{Ignoring Tests}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md452}
...
Ignore this test and return immediately. Output a message stating why the test was ignored.\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md453}{}\doxysection{Aborting Tests}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md453}
...
If My\+Test calls {\ttfamily T\+E\+S\+T\+\_\+\+A\+B\+O\+RT}, program control will immediately return to {\ttfamily T\+E\+S\+T\+\_\+\+P\+R\+O\+T\+E\+CT} with a return value of zero.\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md454}{}\doxysection{Unity Assertion Summary}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md454}
\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md455}{}\doxysubsection{Basic Validity Tests}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md455}
...
This test is automatically marked as a failure. The message is output stating why.\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md456}{}\doxysubsection{Numerical Assertions\+: Integers}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md456}
...
Asserts that the actual value is less than the threshold. This also comes in size specific variants.\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md457}{}\doxysubsection{Arrays}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md457}
...
\end{DoxyVerb}
\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md458}{}\doxysubsection{Numerical Assertions\+: Bitwise}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md458}
...
Test a single bit and verify that it is low. The bit is specified 0-\/31 for a 32-\/bit integer.\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md459}{}\doxysubsection{Numerical Assertions\+: Floats}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md459}
...
Asserts that two floating point values are \char`\"{}equal\char`\"{} within a small \% delta of the expected value.\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md460}{}\doxysubsection{String Assertions}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md460}
...
Compare two strings. Fail if any character is different, stop comparing after len characters. Output a custom message on failure.\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md461}{}\doxysubsection{Pointer Assertions}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md461}
...
Fails if the pointer is equal to N\+U\+LL\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md462}{}\doxysubsection{Memory Assertions}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md462}
\begin{DoxyVerb}TEST_ASSERT_EQUAL_MEMORY(expected, actual, len)
\end{DoxyVerb}


Compare two blocks of memory. This is a good generic assertion for types that can\textquotesingle{}t be coerced into acting like standard types... but since it\textquotesingle{}s a memory compare, you have to be careful that your data types are packed.\hypertarget{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md463}{}\doxysubsection{\+\_\+\+M\+E\+S\+S\+A\+GE}\label{md_c_j_s_o_n_tests_unity__r_e_a_d_m_e_autotoc_md463}
