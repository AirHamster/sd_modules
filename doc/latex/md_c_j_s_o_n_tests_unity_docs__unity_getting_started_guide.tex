\hypertarget{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md431}{}\doxysection{Welcome}\label{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md431}
...
Unity was designed to be cross platform. It works hard to stick with C standards while still providing support for the many embedded C compilers that bend the rules. Unity has been used with many compilers, including G\+CC, I\+AR, Clang, Green Hills, Microchip, and MS Visual Studio. It\textquotesingle{}s not much work to get it to work with a new target.\hypertarget{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md432}{}\doxysubsection{Overview of the Documents}\label{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md432}
\hypertarget{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md433}{}\doxysubsubsection{Unity Assertions reference}\label{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md433}
This document will guide you through all the assertion options provided by Unity. This is going to be your unit testing bread and butter. You\textquotesingle{}ll spend more time with assertions than any other part of Unity.\hypertarget{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md434}{}\doxysubsubsection{Unity Assertions Cheat Sheet}\label{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md434}
This document contains an abridged summary of the assertions described in the previous document. It\textquotesingle{}s perfect for printing and referencing while you familiarize yourself with Unity\textquotesingle{}s options.\hypertarget{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md435}{}\doxysubsubsection{Unity Configuration Guide}\label{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md435}
This document is the one to reference when you are going to use Unity with a new target or compiler. It\textquotesingle{}ll guide you through the configuration options and will help you customize your testing experience to meet your needs.\hypertarget{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md436}{}\doxysubsubsection{Unity Helper Scripts}\label{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md436}
This document describes the helper scripts that are available for simplifying your testing workflow. It describes the collection of optional Ruby scripts included in the auto directory of your Unity installation. Neither Ruby nor these scripts are necessary for using Unity. They are provided as a convenience for those who wish to use them.\hypertarget{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md437}{}\doxysubsubsection{Unity License}\label{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md437}
What\textquotesingle{}s an open source project without a license file? This brief document describes the terms you\textquotesingle{}re agreeing to when you use this software. Basically, we want it to be useful to you in whatever context you want to use it, but please don\textquotesingle{}t blame us if you run into problems.\hypertarget{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md438}{}\doxysubsection{Overview of the Folders}\label{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md438}
...
\end{DoxyItemize}\hypertarget{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md439}{}\doxysection{How to Create A Test File}\label{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md439}
...
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{int} \mbox{\hyperlink{main_8c_a3c04138a5bfe5d72780bb7e82a18e627}{main}}(\textcolor{keywordtype}{void}) \{}
...
It\textquotesingle{}s possible that you will require more customization than this, eventually. For that sort of thing, you\textquotesingle{}re going to want to look at the configuration guide. This should be enough to get you going, though.\hypertarget{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md440}{}\doxysection{How to Build and Run A Test File}\label{md_c_j_s_o_n_tests_unity_docs__unity_getting_started_guide_autotoc_md440}
